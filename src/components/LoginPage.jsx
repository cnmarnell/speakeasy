...
function LoginPage({ onLogin }) {
  ...
  const handleGoogleSignIn = async (role = null) => {
    setIsLoading(true)
    setError('')

    try {
      // Store the selected role for new user creation after OAuth callback
      if (role) {
        localStorage.setItem('speakeasy_signup_role', role)
      } else {
        localStorage.removeItem('speakeasy_signup_role')
      }
      ...
      // Supabase handles the redirect, no need to call onLogin here
    } catch (error) {
      setError(error.message)
      setIsLoading(false)
    }
  ...
  return (
    <div className="login-page">
      ...
      <div className="login-container">
        ...
        {isSignUp ? (
          <div className="google-signup-buttons">
            <button
              type="button"
              className="google-signin-button google-student"
            ...
            >
              ...
              <span>Google Sign Up as Student</span>
            </button>
            <button
              type="button"
              className="google-signin-button google-teacher"
            ...
            >
              ...
              <span>Google Sign Up as Teacher</span>
            </button>
          </div>
        ) : (
          <button
